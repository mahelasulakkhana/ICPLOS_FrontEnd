...
const UserProfile = () => {
  return (
    <div className="flex items-center justify-center mt-20 ">
      <div className="bg-gray-100 p-8 rounded-lg shadow-md border-2 border-green-500">
        <img
        ...
        <label className='relative cursor-pointer  '>
          <div className='mb-2 h-12 w-150 px-6 text-l text-black  border-black border-2 rounded-lg border-opacity-100 outline-none focus:border-blue-500 placeholder-gray-300 placeholder-opacity-0 transition duration-200'>
