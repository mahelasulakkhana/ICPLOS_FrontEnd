    ...
    <div className="App h-screen flex justify-center items-center bg-gray-500">
        ...
        <div className="flex flex-col items-center">
            ...
            <label className='relative cursor-pointer mb-6 '>
                <input type="text" name='email' placeholder="Input" className='h-16 w-150 px-6 text-2xl text-black  border-black border-2 rounded-lg border-opacity-100 outline-none focus:border-blue-500 placeholder-gray-300 placeholder-opacity-0 transition duration-200' />
            ...
            <label className='relative cursor-pointer mb-4'>
                <input type="text" name='password' placeholder="Input" className='h-16 w-150 px-6 text-2xl text-black  border-black border-2 rounded-lg border-opacity-100 outline-none focus:border-blue-500 placeholder-gray-300 placeholder-opacity-0 transition duration-200' />
